extension ReceiptLocale {
    ...
    public static let english = ReceiptLocale(
        ...
        totalMarkers:
            #"\b(sub-?total|total|amount\s*due|balance|cash|card|change|visa|mastercard|tender)\b|thank\s*you"#,
        ...
        householdWords:
            #"\b(bag|napkin|tissue|towel|detergent|bleach|soap|shampoo|sponge|foil|cling ?film|battery|batterie|bulb|candle|pen|pencil|notebook|tape|sticker|toy|razor|deodorant|perfume|nappy|diaper)"#,
        categoryWords: [
            ...
            (
                .produce,
                #"\b(apple|banana|tomato|onion|garlic|spinach|lettuce|carrot|potato|pepper|cucumber|lemon|orange|mushroom|avocado|berry|grape|salad|broccoli|courgette)\b"#
            ),
            ...
            (
                .snacks,
                #"\b(chip|crisp|cracker|cookie|biscuit|chocolate|popcorn|nut|cashew|almond|pistachio|walnut|hazelnut|wafer)\b"#
            ),
        ],
