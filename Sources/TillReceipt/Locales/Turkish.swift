extension ReceiptLocale {
    ...
    public static let turkish = ReceiptLocale(
        ...
        totalMarkers: #"\b(ara\s*toplam|top\s*kdv|topkdv|toplam|mal\s*\/?\s*hizmet|[öo]denecek|matrah|ortak\s*pos|nakit|kredi\s*kart|banka\s*kart)\b"#,
        addressMarkers: #"\b(mahalle|mah\.|cadde|cad\.|sokak|sok\.|bulvar|bulv|mersis|vergi|kasiyer|magaza|no:\s?\d)\b|v\.?\s?d\.?[:\/]|www|http"#,
        discountMarkers: #"^\s*[iİ]nd(?:irim)?\s*[.:]|indirim|kampanya|promosyon|hediye"#,
        householdWords: #"\b(mouse|klavye|kablo|sarj|ampul|bant|band|etiket|stiker|kalem|defter|silgi|zarf|poset|torba|sepet|koli|deterjan|camasir|bulasik|sampuan|sabun|pecete|havlu|mendil|islak|temizlik|yumusatici|corap|terlik|firca|macun|tiras|folyo|strec|kurdan|cakmak|sigara|oyuncak|parfum|deodorant)|\b(pil|mum|ped|bez|bezi)\b"#,
        categoryWords: [
            ...
            (.produce, #"(domate|sogan|ispanak|patate|biber|salatalik|elma|muz|mantar|havuc|kabak|patlican|marul|maydanoz|limon|portakal|uzum|cilek|karpuz|kavun|seftali|armut|kiraz|kayisi|erik|avokado|brokoli|karnabahar|pirasa|roka|dereotu|sarimsak|salkim|meyve|sebze)"#),
            (.condiments, #"(zeytinyag|sirke|salca|seker|hardal|mayonez|ketcap|baharat|zeytin|recel|tahin|pekmez|nutella)|\b(tuz|bal|sos|yag)\b"#),
            (.beverages, #"(kahve|gazoz|limonata|maden suyu|meyve suyu|nektar|ayran)|\b(su|cay|kola|soda)\b"#),
            (.snacks, #"(cips|biskuvi|bisk|cikolata|kraker|gofret|kuruyemis|cerez|kaju|badem|fistik|ceviz|findik|leblebi|aycekirdek|kurabiye|lokum|helva|sakiz|draje|dondurma)"#),
        ],
